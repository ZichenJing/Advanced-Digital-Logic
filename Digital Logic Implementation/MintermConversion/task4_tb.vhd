...
--
-- Create Date:   15:51:32 03/24/2025
-- Design Name:   Minterms testbench
-- Module Name:   D:/New folder/ADL_Lab01_task4/task4_tb.vhd
-- Project Name:  ADL_Lab01_task4
-- Target Device:  FPGA
-- Tool versions:  Xilinx
-- Description:   
-- VHDL Test Bench Created by ISE for module: Minterms_CSA
-- 
-- Revision:
...
ARCHITECTURE behavior OF task4_tb IS 
 
    -- Component Declaration for the Unit Under Test (UUT)
 
    COMPONENT Minterms_CSA
    PORT(
         A : IN  std_logic;
         B : IN  std_logic;
         C : IN  std_logic;
